...
def clear_screen():
  os.system('title Console' if os.name == 'nt' else 'title Console')
...
def main_loop():
  global version, del_new_ln_config, ascii_unicode_config, python_editor_line_num_config, style_none, clr_black, clr_red, clr_green, clr_yellow, clr_blue, clr_magenta, clr_cyan, clr_orange, clr_gray, bgclr_black, bgclr_red, bgclr_green, bgclr_yellow, bgclr_blue, bgclr_magenta, bgclr_cyan, bgclr_white, bgclr_orange, bgclr_gray, style_bold, style_italic, style_strike, style_underline, all_reset, uc_1_FullBlock, uc_1_vertical, uc_2_vertical, uc_1_horizontal, uc_2_horizontal, uc_1_UpRight, uc_2_UpRight, uc_1_UpLeft, uc_2_UpLeft, uc_1_Plus, uc_2_Plus, uc_1_DownRight, uc_2_DownRight, uc_1_DownLeft, uc_2_DownLeft, uc_1_horizontalCdown, uc_2_horizontalCdown, uc_1_horizontalCup, uc_2_horizontalCup, uc_1_verticalCright, uc_2_verticalCright, uc_1_verticalCleft, uc_2_verticalCleft, calculate_ans, vars_input, running_main
  clear_screen()
...
if __name__ == '__main__':
  ...
  asciiGUI.progress_bar(type='cirlce', speed=1, max=100, text="Console does not support libraries. Console does not support libraries. Shell Console is running... ")
