...
\033[1;31m                                                                        ANGELSECURITYTEAM \033[1;31m\033[1;37m""")
  ...
  for key, value in countries.items():
    print(f'\033[0mCode : (\033[36m{key}\033[0m) - \033[32m{value["country"]}\033[0m / (\033[35m{value["count"]}\033[0m)')
    #print("")
  ...
  for page in range(int(last_page)):
    ...
    for ip in find_ip:
      #print("")
      num += 1
      print(f"\033[0m\033[33m[\033[31m{num}\033[0m. '\033[32m{country}\033[0m' \033[37mlink\033[33m] \033[36m>>\033[1;32m", ip, "\033[0m")
      #f.write(f'{ip}\n')
except KeyboardInterrupt:
  print("\033[33m\nYou just terminated the program.\033[0m")
except EOFError:
  print("\033[33m\nYou just terminated the program.\033[0m")
except Exception as e:
  print(f"Something error. Please check your connection...\nError:\n{e}")
finally:
